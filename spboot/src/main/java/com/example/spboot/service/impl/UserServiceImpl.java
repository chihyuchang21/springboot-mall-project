...
public class UserServiceImpl implements UserService {
    ...
    public Integer register(UserRegisterRequest userRegisterRequest) {
        ...
        //使用MD5生成密碼的雜湊值
        String hashedPassword = DigestUtils.md5DigestAsHex(userRegisterRequest.getPassword().getBytes()); //記得轉bytes，不用背
    ...
    public User login(UserLoginRequest userLoginRequest) {
        ...
        //使用MD5生成密碼的雜湊值
        String hashedPassword = DigestUtils.md5DigestAsHex(userLoginRequest.getPassword().getBytes()); //記得轉bytes，不用背
